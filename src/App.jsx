        ...
        {accessToken ? <>
          {tool === 'playlistmixer' ?
            ...
            : tool === 'songsuggestions' ?
              ...
              :
              <StartContainer>
                <StartPageMixer setTool={setTool} />
                <StartPageSuggestions setTool={setTool} setStep={setStep} />
              </StartContainer>
          }
        </>
          :
          <HomeContainer>
            ...
            <TextContainer>
              ...
              <ul>
                <li>Create a new playlist for a certain artist</li>
                <li>Create a new playlist for songs from a certain year</li>
                <li>Remove duplicates from your playlist</li>
                <li>Remove an artist from your playlist</li>
                <li>See your most listened to songs</li>
                <li>See your most listened to artists</li>
              </ul>
              <ButtonContainer>
