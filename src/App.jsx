      ...
      <header className="App-header">
          ...
          <HomeContainer>
            ...
            <TextContainer>
              ...
              <ul>
                <li>Create a playlist for a specific artist from one of your existing playlists</li>
                <li>Create a playlist for a specific year from one of your existing playlists</li>
                <li>Remove duplicates from your playlist</li>
                <li>Remove songs by a specific artist from your playlist</li>
                <li>View your most-played songs</li>
                <li>View your most-played artists</li>
              </ul>
              <ButtonContainer>
                <NavLink to="./playlist"><Button>Use the playlist tools</Button></NavLink>
                <NavLink to="./statistics"><Button>View my most listened to songs & artists</Button></NavLink>
              </ButtonContainer>
            </TextContainer>
          </HomeContainer>
